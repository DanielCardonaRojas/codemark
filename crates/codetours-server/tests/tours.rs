...
async fn setup_app() -> (axum::Router, tempfile::TempDir) {
    ...
    config.auth.dev_token = "dev-secret-not-for-prod".to_string();
...
async fn test_publish_list_get_delete_flow() {
    ...
    let dev_token = "dev-secret-not-for-prod";
    ...
    let pack_path = _tmp.path().join("test.pack.sqlite");
    {
        ...
        let sql = "PRAGMA user_version = 12;
             ...
             INSERT INTO bookmarks (id, file_path, query, language, created_at, status) VALUES ('BM_1', 'src/main.rs', 'query', 'rust', '2026-05-01T00:00:00Z', 'active');
             INSERT INTO collection_bookmarks (collection_id, bookmark_id, position, added_at) VALUES ('COL_ID', 'BM_1', 0, '2026-05-01T00:00:00Z');
             INSERT INTO resolutions (id, bookmark_id, resolved_at, method, headline, preview_lines, line_range) VALUES ('RES_1', 'BM_1', '2026-05-01T00:00:00Z', 'exact', 'headline', 'preview', '10');
             INSERT INTO _pack_meta (pack_id, protocol_version, purpose, source_client, generated_at) VALUES ('PACK_1', 12, 'publish', 'test-client', '2026-05-01T00:00:00Z');"
    ...
    let migration_pack_path = _tmp.path().join("migration.pack.sqlite");
    {
        ...
        let sql = "PRAGMA user_version = 1;
             ...
             INSERT INTO bookmarks (id, query, language, file_path, created_at) VALUES ('BM_1', 'query', 'rust', 'src/main.rs', '2026-05-01T00:00:00Z');
             INSERT INTO collection_bookmarks (collection_id, bookmark_id, added_at) VALUES ('COL_ID', 'BM_1', '2026-05-01T00:00:00Z');
             INSERT INTO resolutions (id, bookmark_id, resolved_at, method) VALUES ('RES_1', 'BM_1', '2026-05-01T00:00:00Z', 'exact');
             INSERT INTO _pack_meta (pack_id, protocol_version, purpose, source_client, generated_at) VALUES ('PACK_1', 1, 'publish', 'test-client', '2026-05-01T00:00:00Z');"
    ...
    let pack_path = _tmp.path().join("malicious.pack.sqlite");
    {
        ...
        conn.execute_batch(
            "PRAGMA user_version = 12;
             ...
             INSERT INTO _pack_meta VALUES ('P', 12, 'publish', 'C', 'T');"
        ).unwrap();
    }
